...
export default function Page() {
	...
	const [filters, setFilters] = useConfigStorage({ localStorageKey: "access-management.filters", customConfigProvider: relationNavigationFilterConfigProvider("accesses"), updateIfThisSearhParamExists: "filters", defaultValue: [] as MenuFilterState[] });
