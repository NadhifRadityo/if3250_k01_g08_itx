...
import { User, CreditApplicationAssignment } from "@/payload-types";
...
async function resolveRelations(
	{ payload, user, docs }:
	{ payload?: Payload, user: User, docs: CreditApplicationAssignment[] }
) {
	...
	Object.assign(relations, await uwsa(resolveRelationCreditApplications)({ payload, user, ids: [...creditApplicationIds] }));
