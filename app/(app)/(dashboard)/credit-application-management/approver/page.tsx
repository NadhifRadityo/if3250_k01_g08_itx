...
export default function Page() {
	...
	const [filters, setFilters] = useConfigStorage({ localStorageKey: "credit-application-management.filters", customConfigProvider: relationNavigationFilterConfigProvider("credit-applications"), updateIfThisSearhParamExists: "filters", defaultValue: [] as MenuFilterState[] });
