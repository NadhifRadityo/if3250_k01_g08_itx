				...
				<div className="flex-1 overflow-y-auto px-4">
					<div className="grid gap-3 pb-4 sm:grid-cols-2">
						...
						<div className="space-y-2">
							...
							<Input type="date" value={formState.otherDate1} onChange={event => updateField("otherDate1", event.target.value)} />
						</div>
						<div className="space-y-2">
							<label className="text-sm font-medium">Other Date 2</label>
							<Input type="date" value={formState.otherDate2} onChange={event => updateField("otherDate2", event.target.value)} />
						</div>
						<div className="space-y-2 sm:col-span-2">
...
export function useCreditApplicationRelations({ docs, visibleColumns }: useCreditApplicationRelationsOptions) {
	...
	) as Record<string, creditApplicationActions.CreditApplicationRelationValues>, [relationsQuery.data]);
