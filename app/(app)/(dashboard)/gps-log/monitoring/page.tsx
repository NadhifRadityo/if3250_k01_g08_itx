...
export default function Page() {
	...
	const [filters, setFilters] = useConfigStorage({ localStorageKey: "gps-log.filters", customConfigProvider: relationNavigationFilterConfigProvider("gps-logs"), updateIfThisSearhParamExists: "filters", defaultValue: [] as MenuFilterState[] });
