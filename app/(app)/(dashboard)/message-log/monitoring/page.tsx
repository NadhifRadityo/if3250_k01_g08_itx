...
export default function Page() {
	...
	const [filters, setFilters] = useConfigStorage({ localStorageKey: "message-log.filters", customConfigProvider: relationNavigationFilterConfigProvider("message-logs"), updateIfThisSearhParamExists: "filters", defaultValue: [] as MenuFilterState[] });
