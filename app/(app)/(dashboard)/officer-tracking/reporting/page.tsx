...
export default function Page() {
	...
	const [filters, setFilters] = useConfigStorage({ localStorageKey: "officer-tracking.filters", customConfigProvider: relationNavigationFilterConfigProvider("gps-logs"), updateIfThisSearhParamExists: "filters", defaultValue: [] as MenuFilterState[] });
