...
export default function Page() {
	...
	const [filters, setFilters] = useConfigStorage({ localStorageKey: "recording-log.filters", customConfigProvider: relationNavigationFilterConfigProvider("recording-logs"), updateIfThisSearhParamExists: "filters", defaultValue: [] as MenuFilterState[] });
