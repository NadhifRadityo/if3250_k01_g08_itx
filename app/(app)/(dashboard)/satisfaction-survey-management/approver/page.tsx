...
export default function Page() {
	...
	const [filters, setFilters] = useConfigStorage({ localStorageKey: "satisfaction-survey-management.filters", customConfigProvider: relationNavigationFilterConfigProvider("satisfaction-surveys"), updateIfThisSearhParamExists: "filters", defaultValue: [] as MenuFilterState[] });
