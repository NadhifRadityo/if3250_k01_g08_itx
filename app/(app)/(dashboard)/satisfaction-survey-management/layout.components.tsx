...
import { defaultStatusRenderer, MenuTableConfigColumn, MenuColumnConfigColumn, MenuFilterConfigColumn, useMenuRowValueRenderer, useDashboardShellContext, defaultRelationUserRenderer, defaultChangeRequestRenderer, MenuRowValueRendererConfigColumn, MenuRowValueRendererContext } from "../layout.components";
import { searchRelationUsersAction, searchRelationSatisfactionSurveysAction } from "../relation-navigation.actions";
...
export const filterConfigColumns = Object.freeze([
	{ key: "id", label: "Id", type: "relation", relationSearch: searchRelationSatisfactionSurveysAction },
...
export const rowValueRendererConfigColumns = Object.freeze([
	...
	{ key: "content", type: "text", render: defaultSurveyContentRenderer({ buttonLabel: "View content", dialogTitle: "Satisfaction Survey Content" }) },
...
export function DetailsDrawer(
	...
	const canAccessHistory = roles.includes("satisfaction-survey-management#auditor");
