...
export default function Page() {
	...
	const query = useQuery({
		queryKey: ["satisfaction-survey-management", "viewer", {
			keyword,
			filters,
			columnsSort,
			includeDeleted,
	...
	return (
		<MenuPage
			...
			description="View satisfaction survey requests across draft, approved, rejected, and deleted states."
		>
				...
				<MenuToolbar
					...
					rightSlot={roles.includes("satisfaction-survey-management-auditor") ? (
						<div className="flex items-center gap-2">
							...
							<Switch
								id="satisfaction-survey-management-viewer-show-deleted"
