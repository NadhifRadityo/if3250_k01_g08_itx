...
import { searchRelationUsersAction, searchRelationSurveysAction } from "../relation-navigation.actions";
...
export const filterConfigColumns = Object.freeze([
	{ key: "id", label: "Id", type: "relation", relationSearch: searchRelationSurveysAction },
...
export const rowValueRendererConfigColumns = Object.freeze([
	...
	{ key: "createdBy", type: "relation", render: defaultRelationUserRenderer({ description: "Created By", relationSource: "surveys.createdBy" }) },
	{ key: "updatedAt", type: "date" },
	{ key: "updatedBy", type: "relation", render: defaultRelationUserRenderer({ description: "Updated By", relationSource: "surveys.updatedBy" }) },
...
export function DetailsDrawer(
	...
	const canAccessHistory = roles.includes("survey-management-auditor");
				...
				<div className="flex-1 space-y-2 overflow-y-auto px-4 pb-4">
					{row == null ? (
						...
						<Alert variant="destructive">
							...
							<AlertDescription>
								{`${query.error?.message ?? "Unable to load survey request details."}`}
							</AlertDescription>
						</Alert>
					) : (
			...
			<DrawerContent className="data-[vaul-drawer-direction=right]:sm:max-w-3xl">
				...
				<div className="flex-1 space-y-3 overflow-y-auto px-4 pb-4">
					{row == null ? (
						...
						<p className="text-muted-foreground text-sm">
							No history entries found for this survey request.
						</p>
					) : (
...
export function ChangeRequestDrawer(
	...
	const query = useQuery({
		queryKey: ["survey-management", "change-request-diff", row?.id ?? null],
		enabled: open && row != null,
