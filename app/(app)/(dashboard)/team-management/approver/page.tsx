...
export default function Page() {
	...
	const query = useQuery({
		queryKey: ["team-management", "approver", {
			keyword,
			filters,
			columnsSort,
			includeDeleted,
	...
	return (
		<MenuPage
			...
			description="Review pending team requests before publication."
				...
				<MenuToolbar
					...
					rightSlot={user.roleMenus.includes("team-management#auditor") ? (
						<div className="flex items-center gap-2">
							<label htmlFor="team-management-approver-show-deleted" className="text-sm">
								Show Deleted
							</label>
							<Switch
								id="team-management-approver-show-deleted"
