...
export const TEAM_FILTER_PREFERENCES_KEY = "team-management-filters-v1";
...
export const defaultTeamVisibleColumns: TeamTableColumnId[] = ["name", "supervisorName", "officerNames", "requestType", "status", "updatedAt", "reviewCommentText"];
...
export function createFilterDraft(column: FilterColumn = teamFilterColumns[0].value): FilterDraft {
...
export function useTeamCellRenderer({ relationValuesByRowId, isRelationLoading }: UseTeamCellRendererOptions) {
...
export function useTeamFilterColumnConfig() {
	...
	const getResolvedFilterColumnConfig = useCallback((column: FilterColumn): FilterColumnOption => (
		getResolvedTeamFilterColumnConfig(column, [], [], [], searchSupervisorOptions, searchOfficerOptions, searchReviewerOptions)
	), [searchOfficerOptions, searchReviewerOptions, searchSupervisorOptions]);
