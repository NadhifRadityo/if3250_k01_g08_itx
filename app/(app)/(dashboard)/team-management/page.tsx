...
type FilterValueType = "text" | "date" | "boolean";
...
const teamFilterColumns: FilterColumnOption[] = [
	...
	{ value: "officers.name", label: "Officer Name", valueType: "text", operators: ["equals", "not_equals", "contains", "not_contains", "in", "not_in", "exists"], placeholder: "Enter officer name" },
	{ value: "officers.email", label: "Officer Email", valueType: "text", operators: ["equals", "not_equals", "contains", "not_contains", "in", "not_in", "exists"], placeholder: "Enter officer email" },
...
export default function Page() {
	...
	const [relationValuesByRowId, setRelationValuesByRowId] = useState<Record<string, Partial<Record<TeamRelationColumn, string>>>>({});
	...
	useEffect(() => {
		...
		void (async () => {
			...
			try {
				...
				const resolved = await teamActions.resolveTeamRelationColumnsAction({
					rows,
