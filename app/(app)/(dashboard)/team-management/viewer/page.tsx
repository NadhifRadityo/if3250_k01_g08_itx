...
export default function Page() {
	...
	const [filters, setFilters] = useConfigStorage({ localStorageKey: "team-management.filters", customConfigProvider: relationNavigationFilterConfigProvider("teams"), updateIfThisSearhParamExists: "filters", defaultValue: [] as MenuFilterState[] });
