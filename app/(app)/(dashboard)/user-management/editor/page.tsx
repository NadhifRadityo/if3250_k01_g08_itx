...
export default function Page() {
	...
	const [columnOrder, setColumnOrder] = useConfigStorage({ localStorageKey: "user-management.column-order", updateIfThisSearhParamExists: "columnOrder", defaultValue: defaultColumnOrderWithActions });
	const [columnsShown, setColumnsShown] = useConfigStorage({ localStorageKey: "user-management.columns-shown", updateIfThisSearhParamExists: "columnsShown", defaultValue: defaultColumnsShownWithActions });
	...
	return (
		<MenuPage
			...
			beforeChildren={<ViewerStatistics filters={filters} onFiltersChange={setFilters} />}
		>
			<RelationNavigationProvider>
				<MenuToolbar
					...
					rightSlot={(
						<>
							{user.roleMenus.includes("user-management#auditor") ? (
