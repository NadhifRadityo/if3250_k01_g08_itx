...
export default function Page() {
	...
	const [filters, setFilters] = useConfigStorage({ localStorageKey: "user-management.filters", customConfigProvider: relationNavigationFilterConfigProvider("users"), updateIfThisSearhParamExists: "filters", defaultValue: [] as MenuFilterState[] });
