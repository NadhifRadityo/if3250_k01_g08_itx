	...
	fields: [
		...
		},
		{
			...
			options: [
				...
				{ value: "officer-task#executor", label: "Officer Task - Executor" },
				{ value: "officer-task#evaluator", label: "Officer Task - Evaluator" },
				...
				{ value: "message-log#monitoring", label: "Message Log - Monitoring" },
				{ value: "message-log#reporting", label: "Message Log - Reporting" },
...
export const RolesSchemaHook = (): PostgresSchemaHook => ({ schema, extendTable }) => {
	extendTable({
		table: schema.tables["roles"],
		extraConfig: () => ({
			rolesReviewedAtNotNullImpliesReviewApprovedNotNull: check(
				"roles_reviewed_at_not_null_implies_review_approved_not_null",
