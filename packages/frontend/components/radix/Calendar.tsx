	...
	return (
		<DayPicker
			...
			classNames={{
				...
				dropdown_root: cn(
					"relative has-focus:border-ring border-input has-focus:ring-ring/50 border shadow-xs has-focus:ring-[3px] rounded-(--cell-radius)",
				...
				caption_label: cn(
					...
					captionLayout === "label" ?
						"text-sm" :
						"h-8 pr-1 pl-2 rounded-(--cell-radius) flex items-center gap-1 text-sm  [&>svg]:text-muted-foreground [&>svg]:size-3.5",
